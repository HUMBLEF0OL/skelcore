...
const rolloutCommands = `# Rollout command surface from @ghostframes/cli
...
export default function CliWorkflowReferencePage() {
    return (
        <div className="space-y-6">
            ...
            <FeatureCard title="Capabilities" description="Current @ghostframes/cli command surface" badge="@ghostframes/cli">
